...
public class EffectRegister {
	...
	public static final UUID STENCH_EFFECT_UUID = UUID.fromString("afc202fb-a4ed-c855-5789-695e966684f9");
	...
	public static final RegistryObject<Effect> COLD_EFFECT = EFFECTS.register("cold", () -> {
		return new PVZEffect(EffectType.HARMFUL, Colors.IRIS_BLUE).addAttributeModifier(Attributes.MOVEMENT_SPEED,
				COLD_EFFECT_UUID.toString(), -0.1f, Operation.MULTIPLY_TOTAL);
	});
	...
	public static final RegistryObject<Effect> STENCH_EFFECT = EFFECTS.register("stench", () -> {
		return new PVZEffect(EffectType.HARMFUL, Colors.CREEPER_GREEN).addAttributeModifier(Attributes.MOVEMENT_SPEED,
				STENCH_EFFECT_UUID.toString(), -0.4f, Operation.MULTIPLY_TOTAL);
	});
}
