...
public class PVZFoodItem extends Item{
	...
	public static final Food FAKE_BRAIN = (new Food.Builder()).nutrition(3).saturationMod(0.7F).build();
	
	public static final Food REAL_BRAIN = (new Food.Builder()).nutrition(2).saturationMod(0.5F).effect(new EffectInstance(Effects.CONFUSION, 200, 1), 1.0f).build();
	...
	public static final Food COOKED_BRAIN = (new Food.Builder()).nutrition(4).saturationMod(1.0f).build();
