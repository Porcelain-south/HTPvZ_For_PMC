...
public class StructureRegister {
	...
	public static void setupStructures() {
		...
		}
		{
			...
			addStructure(DOLPHIN_HOUSE.get(), new StructureSeparationSettings(dis, dis / 2, 246248517));
		...
		}
		{
			...
			addStructure(GRAVE_HOUSE.get(), new StructureSeparationSettings(dis, dis / 2, 521452156));
		...
		}
		{
			...
			addStructure(YETI_HOUSE.get(), new StructureSeparationSettings(dis, dis / 2, 139657264));
		...
		}
		{
			...
			addStructure(DAVE_VILLA.get(), new StructureSeparationSettings(dis, dis / 2, 145961546));
