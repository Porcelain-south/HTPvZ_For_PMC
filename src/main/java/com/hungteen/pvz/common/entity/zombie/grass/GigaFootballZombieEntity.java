...
public class GigaFootballZombieEntity extends FootballZombieEntity {
	...
	private final int minRushCD = 800;
	private final int maxRushCD = 1200;
	...
	protected void updateRush(boolean is) {
		...
		if(! is) {
			...
			if(this.hasEffect(Effects.MOVEMENT_SPEED))
			{
	...
	@Override
	public float getWalkSpeed() { return ZombieUtil.WALK_FAST; }
