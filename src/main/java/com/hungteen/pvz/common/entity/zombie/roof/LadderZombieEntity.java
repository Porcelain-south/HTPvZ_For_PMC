...
public class LadderZombieEntity extends DefenceZombieEntity implements IHasMetal {
	...
	public void decreaseMetal() {
		...
		this.getAttribute(Attributes.MOVEMENT_SPEED).setBaseValue(ZombieUtil.WALK_NORMAL*this.getSkillValue(SkillTypes.ZOMBIE_FAST_MOVE));
	}

	@Override
	public void increaseMetal() {
		this.setOuterDefenceLife(this.getOuterLife());
		this.getAttribute(Attributes.MOVEMENT_SPEED).setBaseValue(ZombieUtil.WALK_FAST*this.getSkillValue(SkillTypes.ZOMBIE_FAST_MOVE));
		this.resetParts();
	}
