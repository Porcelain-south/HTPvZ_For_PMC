...
public class TrickZombieEntity extends PVZZombieEntity{
	...
	public boolean hurt(DamageSource source, float amount) {
		if(amount > 6F && /*!(source.getEntity() instanceof PlayerEntity)*/source instanceof PVZEntityDamageSource && ! level.isClientSide && this.tickCount - this.lastSummonTick >= this.summonGap && this.getRandom().nextInt(SUMMON_CHACNE) == 0) {
