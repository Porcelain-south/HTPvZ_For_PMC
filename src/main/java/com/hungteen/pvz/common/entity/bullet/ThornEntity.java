...
//				if (vec != Vector3d.ZERO) {
					Vector3d sub = vec.subtract(this.getDeltaMovement().normalize());
					Vector3d cut = sub.scale(0.04);
...
//				}
	...
	protected void dealThornDamage(Entity target) {
		target.hurt(PVZEntityDamageSource.causeThornDamage(this, this.getThrower()), this.getAttackDamage());
	}
