...
public class EntityUtil {
	...
	public static boolean isEntityStench(LivingEntity entity) {
		return entity.getAttribute(Attributes.MOVEMENT_SPEED).getModifier(EffectRegister.STENCH_EFFECT_UUID) != null;
	}
	/**
...
//		}
		...
		if(entity instanceof PogoZombieEntity && ! entity.isOnGround() && ! entity.isInWater() && ! entity.isInLava()) {
			return true;
		}
		return false;
	}
