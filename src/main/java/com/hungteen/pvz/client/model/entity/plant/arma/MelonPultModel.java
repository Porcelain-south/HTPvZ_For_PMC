...
public class MelonPultModel extends PVZPlantModel<MelonPultEntity> {
	...
	public MelonPultModel() {
		...
		total.texOffs(0, 0).addBox(-7.0F, -10.5F, -5.0F, 14.0F, 10.0F, 10.0F, 0.2F, false);
		total.texOffs(32, 44).addBox(-7.0F, -8.0F, -5.4F, 14.0F, 2.0F, 0.0F, 0.0F, false);
		...
		pult.texOffs(40, 53).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 9.0F, 0.0F, false);
		...
		bone.texOffs(0, 20).addBox(-5.0F, -2.0F, 3.0F, 10.0F, 5.0F, 10.0F, -0.5F, false);
		bone.texOffs(0, 35).addBox(-4.0F, -1.9F, 4.0F, 8.0F, 4.0F, 8.0F, -0.4F, false);

		melon = new ModelRenderer(this);
		melon.setPos(0.0F, -5.5F, 8.0F);
		bone.addChild(melon);
		setRotationAngle(melon, -0.6545F, 0.0F, 0.0F);
		melon.texOffs(32, 27).addBox(-4.0F, -3.5F, -2.25F, 8.0F, 9.0F, 8.0F, -0.1F, false);
